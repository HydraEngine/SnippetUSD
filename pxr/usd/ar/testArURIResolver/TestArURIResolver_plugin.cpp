...
public:
    _TestOtherURIResolver() : _TestURIResolverBase("test-other") {}
};

// Underbar characters should cause a failure to register under strict mode
class _TestInvalidUnderbarURIResolver : public _TestURIResolverBase {
public:
    _TestInvalidUnderbarURIResolver() : _TestURIResolverBase("test_other") {}
};
...
class _TestInvalidColonURIResolver : public _TestURIResolverBase {
public:
    _TestInvalidColonURIResolver() : _TestURIResolverBase("other:test") {}
};

// UTF-8 characters should cause a failure to register under strict mode
class _TestInvalidNonAsciiURIResolver : public _TestURIResolverBase {
public:
    _TestInvalidNonAsciiURIResolver() : _TestURIResolverBase("test-π-utf8") {}
};

// Schemes starting with numeric characters should cause a failure to
// register under strict mode
class _TestInvalidNumericPrefixResolver : public _TestURIResolverBase {
public:
    _TestInvalidNumericPrefixResolver() : _TestURIResolverBase("113-test") {}
};
